...
//       <button className={styles.settingsToggle} onClick={() => setIsOpen(!isOpen)}>
//         ⚙️ Settings
//       </button>
//       {isOpen && (
//         <div className={styles.settingsPanel}>
//           <VectorSettings
//             onChange={({ azureRAG, lightRAG }) => {
//               onUseAzureRagChanged(azureRAG);
//               onUseLightRagChanged(lightRAG);
//             }}
//           />
//         </div>
//       )}
//       {/* Always show vector settings to admin for system or domain-level query mode control */}
//       <div className={styles.vectorAdminPanel}>
//         <VectorSettings
//           onChange={({ azureRAG, lightRAG }) => {
//             onUseAzureRagChanged(azureRAG);
//             onUseLightRagChanged(lightRAG);
...
export const Settings = ({
    ...
    return (
        <div className={className}>
            ...
            {/* Vector Settings - now always shown */}
            <VectorSettings
                useAzureRag={useAzureRag}
                useLightRag={useLightRag}
                onUseAzureRagChanged={val => onChange("useAzureRag", val)}
                onUseLightRagChanged={val => onChange("useLightRag", val)}
            />
